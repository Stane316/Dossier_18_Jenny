      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        <Reveal delay={120}>
          <h1 className="mt-8 font-display text-[clamp(2.2rem,5vw,3.8rem)] font-black leading-[0.9] text-bone">
            Merci, <span className="italic text-ember">témoin.</span>
          </h1>
          <p className="mx-auto mt-6 max-w-xl font-mono text-[13px] leading-relaxed text-bone/75">
            Votre dépôt a été versé au dossier. Il sera examiné puis scellé dans la partie privée
            de Jenny — elle le découvrira le 13 août, avec toutes les autres preuves d'amour.
          </p>
          {isLocal && (
